...
//                "<html><head><meta charset='UTF-8'></head><body><ul><li class=welcome><div class=message><div class=content>" +
//                        welcome +
//                        "</div></div></li></ul></body></html>",
//                "UTF-16",

                "<html><head><meta charset='UTF-8'>" +
                        "</head><body><ul><li class='welcome'>" +
    ...
    private String decodeUID(String msg) {
        // długość słów kluczowych komunikatów
        int PROTOCOL_PREFIX_LENGTH = 3;
